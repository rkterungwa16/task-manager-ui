export enum ProjectActions {
  ...
  EDIT_PROJECT_TASK = "PROJECTS/EDIT_PROJECT_TASK",
  EDIT_PROJECT_TASK_SUCCESS = "PROJECTS/EDIT_PROJECT_TASK_SUCCESS",
  EDIT_PROJECT_TASK_FAILURE = "PROJECTS/EDIT_PROJECT_TASK_FAILURE"
}
